 ...
 * Most methods are already implemented which call on the {@link #read()},
 * {@link #getPosition()} and {@link #setPosition(long)} methods.
 */
public abstract class ReadOnlyByteBuffer {
     ...
     *
     * @param isLittleEndian
     *                       The new endianness: true for little-endian, false for
     *                       big-endian.
     */
