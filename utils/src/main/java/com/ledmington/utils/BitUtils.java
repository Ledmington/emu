 ...
 * <p>
 * Note: the existence of this class justifies a porting of the code
...
public final class BitUtils {
     ...
     * @return
     *      The rightmost byte of the given int.
     */
     ...
     * @return
     *      The rightmost byte of the given long.
     */
     ...
     * @return
     *      A short with the given byte as the rightmost one.
     */
     ...
     *      The long to be converted.
     * @return
     *      The 2 rightmost bytes of the given long.
     */
     ...
     *      The byte to be converted.
     * @return
     *      An int with the given byte as the rightmost one.
     */
     ...
     *      The long to be converted.
     * @return
     *      The 4 rightmost bytes of the given long.
     */
     ...
     *      The byte to be converted.
     * @return
     *      A long with the given byte as the rightmost one.
     */
     ...
     * @return
     *      A long with the given short as the 2 rightmost bytes.
     */
     ...
     *      The int to be converted.
     * @return
     *      A long with the given int as the 4 rightmost bytes.
     */
