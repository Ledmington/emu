...
public final class TestIndirectOperand {
    private static Stream<Arguments> correctIndirectOperands() {
        return Stream.of(
                Arguments.of(IndirectOperand.builder().reg1(Register32.EAX), "[eax]"),
                Arguments.of(IndirectOperand.builder().reg1(Register32.EAX).displacement((byte) 0x12), "[eax+0x12]"),
                Arguments.of(
                        IndirectOperand.builder().reg1(Register32.EAX).displacement((short) 0x1234), "[eax+0x1234]"),
                Arguments.of(
                        IndirectOperand.builder().reg1(Register32.EAX).displacement(0x12345678), "[eax+0x12345678]"),
                Arguments.of(
                        IndirectOperand.builder().reg1(Register32.EAX).displacement(0x1123456789abcdefL),
                        "[eax+0x1123456789abcdef]"),
                Arguments.of(IndirectOperand.builder().reg1(Register32.EAX).displacement((byte) 0x82), "[eax-0x7e]"),
                Arguments.of(
                        IndirectOperand.builder().reg1(Register32.EAX).displacement((short) 0x8234), "[eax-0x7dcc]"),
                Arguments.of(
                        IndirectOperand.builder().reg1(Register32.EAX).displacement(0x82345678), "[eax-0x7dcba988]"),
                Arguments.of(
                        IndirectOperand.builder().reg1(Register32.EAX).displacement(0x8123456789abcdefL),
