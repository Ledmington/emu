...
public final class InstructionChecker {
	...
	private static final Map<Opcode, List<Case>> CASES = Map.<Opcode, List<Case>>ofEntries(
			...
			Map.entry(Opcode.SHR, List.of(R8_R8, R16_R8, R32_R8, R64_R8, R8_I8, R16_I8, R32_I8, R64_I8, M32_R8)),
			Map.entry(Opcode.SAR, List.of(R8_R8, R16_R8, R32_R8, R64_R8, R8_I8, R16_I8, R32_I8, R64_I8, M32_I8)),
			Map.entry(
					Opcode.SHL, List.of(R8_R8, R16_R8, R32_R8, R64_R8, M32_R8, R8_I8, R16_I8, R32_I8, R64_I8, M32_I8)),
			...
			Map.entry(Opcode.MUL, List.of(R8, R16, R32, R64, M8, M64)),
			Map.entry(
					Opcode.OR,
					List.of(
							R8_R8, R16_R16, R32_R32, R64_R64, R8_I8, R16_I16, R32_I8, R32_I32, R64_I8, R64_I32, R8_M8,
							R32_M32, R64_M64, M8_I8, M16_I8, M16_I16, M32_I8, M32_I32, M64_I8, M64_I32, M8_R8, M16_R16,
							M32_R32, M64_R64)),
			Map.entry(
					Opcode.XOR,
					List.of(
							R8_R8, R16_R16, R32_R32, R64_R64, R8_I8, R16_I16, R32_I8, R32_I32, R64_I8, R64_I32, M8_R8,
							M32_R32, R8_M8, R32_M32, R64_M64, M8_I8, M32_I8, M32_I32)),
			...
			Map.entry(Opcode.ROR, List.of(R8_R8, M32_R8, R8_I8, R16_I8, R32_I8, R64_I8)),
			Map.entry(Opcode.ROL, List.of(R8_R8, R32_R8, R8_I8, R16_I8, R32_I8, R64_I8)),
			Map.entry(Opcode.RCR, List.of(R8_R8, R32_R8, R64_R8, R8_I8, R32_I8, M32_R8, M64_R8)),
