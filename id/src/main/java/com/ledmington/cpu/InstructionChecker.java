...
public final class InstructionChecker {
	...
	private static final Map<Opcode, List<OperandTypeList>> CASES = Map.<Opcode, List<OperandTypeList>>ofEntries(
			...
			Map.entry(Opcode.MOVSD, List.of(RX_M64, M64_RX)),
			...
			Map.entry(
					Opcode.VPCMPEQD,
					List.of(RK_RX_RX, RK_RY_RY, RK_RZ_RZ, RY_RY_M256, RK_RX_M128, RK_RY_M256, RK_RZ_M512)),
			...
			Map.entry(Opcode.FLD, List.of(M32, M64, M80)),
			Map.entry(Opcode.FILD, List.of(M16, M32)),
			Map.entry(Opcode.FISTTP, List.of(M32)),
			Map.entry(Opcode.FIST, List.of(M32)),
			Map.entry(Opcode.FISTP, List.of(M32)),
			Map.entry(Opcode.FSTP, List.of(M80)),
