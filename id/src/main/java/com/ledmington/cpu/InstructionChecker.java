...
public final class InstructionChecker {
	...
	private static final Map<Opcode, List<OperandTypeList>> CASES = Map.<Opcode, List<OperandTypeList>>ofEntries(
			...
			Map.entry(Opcode.VMOVDQA, List.of(RY_M256, M256_RY, RX_M128, M128_RX)),
			Map.entry(Opcode.VMOVDQU, List.of(RY_M256, M256_RY, RX_M128, M128_RX)),
			...
			Map.entry(Opcode.VPTESTNMB, List.of(RK_RY_RY)),
